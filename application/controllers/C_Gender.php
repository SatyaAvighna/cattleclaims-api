...
class C_Gender extends CI_Controller {
	...
	public function add()
	{
		...
		$result = $this->gender->insertGenderById($data);	
		if($result)
		{
			$arry['status'] = "success";
	...
	public function retrive()
	{
		...
		if(!empty($data['Gender_Id']))
		{
			$this->encryption->initialize(array('driver' => 'openssl','cipher' => 'aes-256','mode' => 'ctr'));
			$data['sId'] =  $this->encryption->decrypt($data['sId']);
			$lists = $this->gender->getGenderById($data);	
			$arry['status'] = "success";
	...
	public function update()
	{
		...
		if(!empty($data['Gender_Id']))
		{
			...
			$this->encryption->initialize(array('driver' => 'openssl','cipher' => 'aes-256','mode' => 'ctr'));
			$data['sId'] =  $this->encryption->decrypt($data['sId']);
			$result = $this->gender->updateGenderById($data);	
			if($result)
			{
				$arry['status'] = "success";
	...
	public function delete()
	{
		...
		if(!empty($data['Gender_Id']))
		{
			...
			$this->encryption->initialize(array('driver' => 'openssl','cipher' => 'aes-256','mode' => 'ctr'));
			$data['sId'] =  $this->encryption->decrypt($data['sId']);
			$result = $this->gender->deleteGenderById($data);	
			if($result)
			{
				$arry['status'] = "success";
